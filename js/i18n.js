...
const APP_ID = {
  ...
  'Cycling purchases': 'Belanja sepeda', 'Everything bought for cycling': 'Semua yang dibeli untuk bersepeda',
  'All cycling items from your Tokopedia and Shopee orders: parts, tools and small stuff. Amounts are what you paid after discounts. Only you can see this.': 'Semua barang sepeda dari pesanan Tokopedia dan Shopee kamu: part, alat, dan barang kecil. Nominal adalah yang kamu bayar setelah diskon. Hanya kamu yang bisa melihat ini.',
...
const TR_ID = {
  ...
  'Climbing Power': 'Power Tanjakan',
  'FTP without a power meter': 'FTP tanpa power meter',
  'Scan my climbs': 'Pindai tanjakan saya',
  'Rescan climbs': 'Pindai ulang tanjakan',
  'Line': 'Garis',
  'per extra bpm, from {0} climbs ({1}–{2} bpm)': 'per tambahan 1 bpm, dari {0} tanjakan ({1}–{2} bpm)',
  'at threshold HR ≈ {0} bpm (89% of your {1} max)': 'di HR ambang ≈ {0} bpm (89% dari max {1})',
  'At max HR': 'Di HR max',
  '≈ power at VO₂max (used for the VO₂max estimate)': '≈ power saat VO₂max (dipakai untuk estimasi VO₂max)',
  'Hardest climb': 'Tanjakan terberat',
  'Only {0} steady climbs with heart rate so far — need {1} for a reliable line.': 'Baru {0} tanjakan stabil dengan detak jantung — butuh {1} agar garisnya andal.',
  'Scanning climbs… {0}': 'Memindai tanjakan… {0}',
  'Watts from the altitude of your {0} hilliest rides at {1} kg total — not Strava’s estimated watts.': 'Watt dari ketinggian {0} gowes paling menanjak, massa total {1} kg — bukan watt tebakan Strava.',
  'No power meter, so Strava’s watts are guesses. Your climbs give a real number: going uphill, power is mostly lifting your weight, which the altitude data measures. Paired with your heart rate, even easy climbs reveal your threshold.': 'Tanpa power meter, watt Strava hanya tebakan. Tanjakan memberi angka nyata: saat menanjak, power sebagian besar untuk mengangkat berat badan, yang terukur dari data ketinggian. Dipasangkan dengan detak jantung, tanjakan santai pun menunjukkan ambang Anda.',
  ...
  'Night before': 'Malam sebelumnya',
  'Above baseline': 'Di atas baseline',
  'Below baseline': 'Di bawah baseline',
  '{0} matters for you: a better night before shows up as a better ride.': '{0} berpengaruh untuk Anda: malam yang lebih baik terlihat di gowes yang lebih baik.',
  '{0} runs against expectation for you — rides after a “better” night were no better, often worse.': '{0} berlawanan dengan dugaan — gowes setelah malam yang “lebih baik” tidak lebih baik, sering malah lebih buruk.',
  'No clear effect yet: across these rides, last night’s HRV, resting HR and sleep don’t predict how fast or at what heart rate you ride. Your pace is set more by the route and how hard you choose to go than by recovery — so the Readiness score is a guide for how hard to go, not a forecast of your speed.': 'Belum ada efek yang jelas: dari gowes-gowes ini, HRV, RHR dan tidur semalam tidak memprediksi seberapa cepat atau di detak jantung berapa Anda gowes. Kecepatan Anda lebih ditentukan rute dan seberapa keras Anda memilih gowes daripada pemulihan — jadi skor Readiness adalah panduan seberapa keras gowes, bukan ramalan kecepatan.',
  '✓ = beyond chance (|r| ≥ 2/√n). Positive km/h = faster than usual for that route; negative bpm = lower heart rate than usual for that speed. {0} rides with heart rate matched to a night.': '✓ = di luar kebetulan (|r| ≥ 2/√n). km/h positif = lebih cepat dari biasanya untuk rute itu; bpm negatif = detak jantung lebih rendah dari biasanya untuk kecepatan itu. {0} gowes dengan detak jantung yang cocok dengan satu malam.',
  'Training Zones': 'Zona Latihan',
  'Power': 'Power',
  'Heart rate': 'Detak jantung',
  'threshold ≈ {0} bpm': 'ambang ≈ {0} bpm',
  'Sweet spot': 'Sweet spot',
  'Threshold': 'Ambang',
  'VO₂max': 'VO₂max',
  'Anaerobic': 'Anaerobik',
  'Easy rides belong in Z2 (both columns agree). Sweet spot and Z4 build FTP; keep them to 1–2 sessions a week.': 'Gowes santai sebaiknya di Z2 (kedua kolom sejalan). Sweet spot dan Z4 menaikkan FTP; cukup 1–2 sesi per minggu.',
  'From your runs': 'Dari lari Anda',
  'Potential': 'Potensi',
  'from cycling VO₂max {0}': 'dari VO₂max sepeda {0}',
  '{0} months ago': '{0} bulan lalu',
  'on': 'pada',
  'Half': 'Half',
  'Marathon': 'Maraton',
  '“From your runs” is what your best logged run supports today. “Potential” is the ceiling your aerobic engine allows — reaching it takes running training (legs, economy), and Half/Marathon also need long-run endurance. A 5K time trial updates the first row best.': '“Dari lari Anda” adalah yang didukung lari terbaik yang tercatat. “Potensi” adalah batas atas mesin aerobik Anda — untuk mencapainya perlu latihan lari (kaki, ekonomi lari), dan Half/Maraton juga butuh daya tahan lari jauh. Tes 5K paling bagus untuk memperbarui baris pertama.',
  ...
  'No real difference: {0} vs {1} — efficiency {2}%, speed {3}%.': 'Tidak ada perbedaan berarti: {0} vs {1} — efisiensi {2}%, kecepatan {3}%.',
  'After {0} ({1} rides) you rode {2}% {3} efficiently and {4}% {5} than after {6} ({7} rides).': 'Setelah {0} ({1} ride) kamu {2}% {3} efisien dan {4}% {5} dibanding setelah {6} ({7} ride).',
  'less': 'kurang', 'more': 'lebih', 'slower': 'lebih lambat', 'faster': 'lebih cepat',
  'No clear effect': 'Tidak ada efek jelas', 'Weak effect': 'Efek lemah', 'Moderate effect': 'Efek sedang', 'Strong effect': 'Efek kuat',
  'Sleep duration': 'Durasi tidur', 'Blood oxygen (SpO₂)': 'Oksigen darah (SpO₂)', 'Deep sleep': 'Tidur dalam', 'Efficiency': 'Efisiensi',
  'deep sleep': 'tidur dalam', 'resting HR': 'HR istirahat', 'stress': 'stres',
  'nights under 6 h': 'malam di bawah 6 jam', 'nights of 7 h+': 'malam 7 jam+', 'bedtime after midnight': 'tidur lewat tengah malam', 'bedtime before 23:00': 'tidur sebelum 23:00', '4+ wake-ups': '4+ kali terbangun', '0–1 wake-ups': '0–1 kali terbangun',
  ...
  'Loading your purchases…': 'Memuat belanjaan kamu…', 'Purchase data unavailable right now.': 'Data belanja sedang tidak tersedia.',
  'The purchase table was not found in the finance app’s database — it may have been renamed. The Ascent /api/purchases query needs updating to match.': 'Tabel belanja tidak ditemukan di database aplikasi keuangan — mungkin sudah diganti namanya. Query /api/purchases di Ascent perlu disesuaikan.',
  'The finance app has no built purchase list yet (purchase_data “items” row missing) — open Spending there and sync once.': 'Aplikasi keuangan belum punya daftar belanja (baris “items” di purchase_data tidak ada) — buka Spending di sana dan sync sekali.',
  'The dashboard’s read-only database login (ascent_ro) no longer has access to the purchase table.': 'Login database read-only dashboard (ascent_ro) sudah tidak punya akses ke tabel belanja.',
  'Purchases loaded, but none are in the “Cycling” category — it may have been renamed in the finance app.': 'Data belanja termuat, tapi tidak ada yang berkategori “Cycling” — mungkin kategorinya diganti nama di aplikasi keuangan.',
  'NEON_PURCHASES_URL is not set on this deployment.': 'NEON_PURCHASES_URL belum diatur di deployment ini.',
  'Total cycling spend': 'Total belanja sepeda', 'Parts & gear (excl. bikes)': 'Part & perlengkapan (tanpa sepeda)', 'Tools & maintenance': 'Alat & perawatan',
  'Small stuff (< Rp100rb)': 'Barang kecil (< Rp100rb)', 'Biggest buy': 'Pembelian terbesar', '{0} items · {1} orders': '{0} barang · {1} pesanan', '{0} items': '{0} barang',
  'Search cycling purchases…': 'Cari belanja sepeda…', 'Small stuff only': 'Barang kecil saja', '{0} items · {1}': '{0} barang · {1}', 'Part': 'Bagian', 'Shop': 'Toko', 'Site': 'Situs',
  'Qty': 'Jml', 'Paid': 'Dibayar', 'Item': 'Barang', 'bike': 'sepeda', 'unknown': 'tak diketahui',
  'Frame & bike': 'Frame & sepeda', 'Wheels & tyres': 'Roda & ban', 'Apparel & shoes': 'Pakaian & sepatu', 'Electronics & mounts': 'Elektronik & dudukan', 'Cockpit': 'Kokpit',
  'Other cycling': 'Sepeda lainnya', 'Drivetrain': 'Drivetrain', 'Brakes': 'Rem', 'Bottles & bags': 'Botol & tas',
  'Include parts & gear bought on Tokopedia/Shopee: {0} ({1} items)': 'Masukkan part & perlengkapan dari Tokopedia/Shopee: {0} ({1} barang)',
  'Not counted (bikes already priced above): {0}': 'Tidak dihitung (sepeda sudah dihargai di atas): {0}', 'Bikes + tools + parts · {0}': 'Sepeda + alat + part · {0}',
  'Road': 'Road', 'Gravel': 'Gravel', 'Mountain': 'MTB', 'Cyclocross': 'Cyclocross', 'Time trial': 'Time trial', 'Hybrid': 'Hybrid',
  'Bike type': 'Jenis sepeda', 'Type…': 'Jenis…', 'Rides': 'Ride', 'Flat rides speed': 'Kecepatan ride datar', 'Climbing': 'Tanjakan', 'Avg distance': 'Jarak rata-rata',
  'Bike comparison': 'Perbandingan sepeda', 'Outdoor rides only. Flat rides = under 8 m climbing per km, the fairest speed comparison.': 'Hanya ride outdoor. Ride datar = tanjakan di bawah 8 m per km, perbandingan kecepatan paling adil.',
  'Flat rides': 'Ride datar', 'All rides': 'Semua ride', '{0}: about the same on both.': '{0}: kurang lebih sama di kedua sepeda.',
  'Flat rides: {0} faster on the {1} ({2} vs {3}).': 'Ride datar: {0} lebih cepat pakai {1} ({2} vs {3}).',
  'All rides: {0} faster on the {1} ({2} vs {3}).': 'Semua ride: {0} lebih cepat pakai {1} ({2} vs {3}).',
  'Efficiency (distance per heartbeat) is about the same on both.': 'Efisiensi (jarak per detak jantung) kurang lebih sama di kedua sepeda.',
  'You cover {0} more distance per heartbeat on the {1} — the same effort goes further.': 'Kamu menempuh {0} lebih jauh per detak jantung pakai {1} — usaha yang sama, jarak lebih jauh.',
  'Average power: {0} W on the {1} vs {2} W on the {3}.': 'Daya rata-rata: {0} W pakai {1} vs {2} W pakai {3}.',
  '({0}: mostly estimated by Strava, not a power meter — compare with care.)': '({0}: sebagian besar estimasi Strava, bukan power meter — bandingkan dengan hati-hati.)',
  'Average heart rate: {0} bpm on the {1} vs {2} bpm on the {3}.': 'HR rata-rata: {0} bpm pakai {1} vs {2} bpm pakai {3}.',
  'Your {0} rides are hillier: {1} m climbing per km vs {2} on the {3}.': 'Ride pakai {0} lebih menanjak: {1} m tanjakan per km vs {2} pakai {3}.',
  'You ride the {0} most: {1} rides vs {2}, averaging {3} vs {4} per ride.': 'Kamu paling sering pakai {0}: {1} ride vs {2}, rata-rata {3} vs {4} per ride.',
